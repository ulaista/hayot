...
export default function HeroSection() {
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center bg-[url('/hero-bg.jpg')] bg-cover bg-center bg-no-repeat p-4 text-center sm:w-1/2 md:bg-none">
        <motion.div
          className="w-full p-1 backdrop-brightness-50 xl:w-8/12"
